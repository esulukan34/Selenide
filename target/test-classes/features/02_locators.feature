...
#   2. test caseleri yaz
#   3. yeni test adimlari icin yeni bir step definition class olustur ve step definitions(java methodlari) olustur
#   4. Page class olustur pages klasorunun altinda
#   5. kullaniciAdi, sifresi ve submit o sayfada bul
#   6.